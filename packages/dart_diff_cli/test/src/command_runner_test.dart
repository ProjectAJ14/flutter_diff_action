...
import 'package:dart_diff_cli/src/command_runner.dart';
import 'package:dart_diff_cli/src/version.dart';
...
void main() {
  group('DartDiffCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late DartDiffCliCommandRunner commandRunner;
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = DartDiffCliCommandRunner();
